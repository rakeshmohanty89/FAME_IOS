...
public class TC_26 extends Lib_SeeTest{
	public void Test_TC_26(Lib_Global ogbl) throws Exception {
		try {
			SetGlobalObject(ogbl);
			oAppLib.Verify_AppOpened();

			if(oAppLib.Functionality_Select("Book Flight")){			
				oAppLib.SearchFlightRound_Trip(TD("Origin_airport"),TD("Destination_airport"),TD("Departure_dt"),TD("Arrival_dt"),TD("Adult_no"),TD("Child_no") ,TD("Youth_no"),"Yes");
				//Departure Flight
				...
				//Return Flight
				oAppLib.SelectFlight(TD("Destination_airport"),TD("Origin_airport"),TD("ASort_by"),TD("AFlight_type"),0,TD("AFlight_no"));
				...
				oAppLib.ValidateBooKSummary(TD("Origin_airport"),TD("Destination_airport"), "Roundtrip", "1");

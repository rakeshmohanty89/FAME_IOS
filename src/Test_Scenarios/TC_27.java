...
public class TC_27 extends Lib_SeeTest{
	public void Test_TC_27(Lib_Global ogbl) throws Exception {
		try {
			...
			if(oAppLib.Functionality_Select("Book Flight")){			
				...
				oAppLib.TravelOption(TD("Traveloptn2"),true,true,0);		
				oAppLib.TravelOption(TD("Traveloptn3"),true,true,1);			
				...
				oAppLib.ValidateBooKSummary(TD("Origin_airport"),TD("Destination_airport"), "Roundtrip", "3");

...
public class TC_31 extends Lib_SeeTest{
	public void Test_TC_31(Lib_Global ogbl) throws Exception {
		try {
			...
			if(oAppLib.Functionality_Select("Book Flight")){			
				...
				oAppLib.TravelOption(TD("Traveloptn1"),true,true,0);
				oAppLib.TravelOption(TD("Traveloptn2"),true,true,1);
